import { getFundList, IRowOfFundList } from './fundList.js'
import { getDetail, type IClassifiedFund } from './fundDetail.js'
import { getTransactionRate, IRateAtRedemptionWithFrontEnd } from './transactionRate.js'
import { listFilter, detailFilter, transactionRateFilter } from '../config/process.js'
